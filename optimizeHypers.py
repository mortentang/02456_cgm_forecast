...
# ray.init(address='10.16.162.178:6379', _redis_password='5241590000000000', local_mode=True)
...
def searchBestHypers(num_samples=10, max_num_epochs=15, n_epochs_stop=2, grace_period=5, gpus_per_trial=0, data_obj=None):
    ...
    test_rmse_val = test_rmse(best_trained_model, data_obj, 'cuda:0')
...
if __name__ == "__main__":
    ...
    experiment_id = searchBestHypers(num_samples=2, n_epochs_stop=5, max_num_epochs=2,
                                     gpus_per_trial=0.2, grace_period=2, data_obj=data_obj_hyperOpt)
