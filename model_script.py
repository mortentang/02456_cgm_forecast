...
train_cgm(config, max_epochs=1, grace_period=5,
          n_epochs_stop=20, data_obj=data_obj, useRayTune=False)
...
#copyfile(best_epoch_checkpoint_file_name, model_path_id / 'checkpoint')
